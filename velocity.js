...
function update() {
    ...
    game.physics.arcade.overlap(aliens, diamonds, checkShield, null, this);
    ...
    if (fireButton.isDown) {
        ...
        if (shieldSpeed > 0){
            game.time.events.add(Phaser.Timer.SECOND * shieldSpeed*0.90, deactivateShield, this);
            game.time.events.add(Phaser.Timer.SECOND * shieldSpeed + Phaser.Timer.SECOND * 0.1, activateShield, this);
        }
